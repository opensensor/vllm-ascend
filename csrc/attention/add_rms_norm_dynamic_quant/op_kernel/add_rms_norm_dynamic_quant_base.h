...
/*!
 * \file add_add_rms_norm_dynamic_quant_base.h
 * \brief
 */
...
public:
    ...
    __aicore__ inline void InitInGlobalTensors(
        GM_ADDR x, GM_ADDR residual, GM_ADDR gamma, GM_ADDR smooth1, GM_ADDR smooth2, GM_ADDR beta)
    {
        xGm.SetGlobalBuffer((__gm__ T*)(x) + blockIdx_ * this->gmOffset_);
        residualGm.SetGlobalBuffer((__gm__ T*)(residual) + blockIdx_ * this->gmOffset_);
    ...
    __aicore__ inline void InitOutGlobalTensors(
        GM_ADDR y1, GM_ADDR y2, GM_ADDR residualOut, GM_ADDR outScale1, GM_ADDR outScale2)
    {
        ...
        residualOutGm.SetGlobalBuffer((__gm__ T*)(residualOut) + blockIdx_ * this->gmOffset_);
